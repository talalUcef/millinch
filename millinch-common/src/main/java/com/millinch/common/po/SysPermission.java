 ...
 */
@Entity
@Table(name = "sys_permission", schema = "", catalog = "millinch_ums")
public class SysPermission {
    ...
    private Set<SysRolePermission> sysRolePermissionsById;
    ...
    public boolean equals(Object o) {
        ...
        if (nameLocation != null ? !nameLocation.equals(that.nameLocation) : that.nameLocation != null) return false;
        ...
        if (corrector != null ? !corrector.equals(that.corrector) : that.corrector != null) return false;
    ...
    public Set<SysRolePermission> getSysRolePermissionsById() {
        return sysRolePermissionsById;
    }

    public void setSysRolePermissionsById(Set<SysRolePermission> sysRolePermissionsById) {
        this.sysRolePermissionsById = sysRolePermissionsById;
    }
}
